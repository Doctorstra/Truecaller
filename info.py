...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "ɴᴀᴍᴇ: <code>{file_name}</code> \n\n**⚡JOIN NOW:** [♕𝐃𝐀𝐃𝐒 𝐋𝐈𝐍𝐊𝐒](https://t.me/Dads_Links)\n\n❤️ 𝐅𝐨𝐥𝐥𝐨𝐰 𝐨𝐧: [𝐈𝐧𝐬𝐭𝐚𝐠𝐫𝐚𝐦](https://instagram.com/dads_links?igshid=NjNlMDhmYTc=)\n\n🔥 𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐛𝐞 𝐎𝐮𝐫 𝐂𝐡𝐚𝐧𝐧𝐞𝐥: [𝐘𝐨𝐮𝐓𝐮𝐛𝐞](https://youtube.com/@Dads_Links)</b>")
