...
async def next_page(bot, query):
    ...
    btn.insert(0, 
        [
            InlineKeyboardButton(text="⚡ 𝐇𝐎𝐖 𝐓𝐎 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 ⚡", url='https://t.me/My_Girlfriend_is_An_Alien2_tamil/2533')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('꧁♕𝐃𝐀𝐃𝐒 𝐋𝐈𝐍𝐊𝐒꧂')
            else:
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton(f"{stat}", callback_data=f"{cb}:{group_id}"),
             InlineKeyboardButton("🗑️ Dᴇʟᴇᴛᴇ", callback_data=f"deletecb:{group_id}")],
    ...
    if query.data.startswith("file"):
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text text=script.START_TXT.format(query.from_user.mention, temp.U_NAME, temp.B_NAME),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
        await query.answer('꧁♕𝐃𝐀𝐃𝐒 𝐋𝐈𝐍𝐊𝐒꧂')
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text                      text=script.HELP_TXT.format(query.from_user.mention),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
